    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="applicant_auth.php" method="POST">
          ...
          <button type="submit" name="btn_applicant_login" class="btn btn-primary btn-block">🔐 Login</button>
          <button type="button" class="btn btn-secondary btn-block mt-2" data-toggle="modal" data-target="#agreementModal">📝 Register</button>
        </form>
      </div>
    </div>
  </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" class="btn btn-register btn-block" data-toggle="modal" data-target="#registerApplicant">I Agree</a>
                </div>
            </div>
        </div>
    </div>
...
<div id="takerModal" class="modal">
    <div class="modal-content">
        ...
        <form id="takerForm" method="POST" action="schedule_handler.php">
            ...
            <select id="examTime" name="exam_time" required>
            ...
            <select id="testingRoom" name="testing_room" required>
            ...
            <button type="button" onclick="closeModal('takerModal')">Cancel</button>
        </form>
    </div>
</div>
