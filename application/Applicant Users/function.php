...
if (isset($_POST['btn_add'])) {
    ...
    $su = mysqli_query($con,"SELECT * from tbl_applicants where username = '".$txt_username."' ");
    ...
    if(move_uploaded_file($temp, 'image/'.$image))
                    {
                    $txt_image = $image;
                    $query = mysqli_query($con,"INSERT INTO tbl_applicants
            ...
            if($query == true)
                ...
                $su = mysqli_query($con,"SELECT * from tbl_applicants where username = '".$txt_edit_username."' and id not in (".$txt_id.") ");
                $ct = mysqli_num_rows($su);
                ...
                if(move_uploaded_file($temp, 'image/'.$image))
                {
                    ...
                    $update_query = mysqli_query($con,"UPDATE tbl_applicants set 
                    ...
                    or die('Error: ' . mysqli_error($con));
                            ...
                            $chk_image = mysqli_query($con,"SELECT * from tbl_applicants where id = '".$_POST['hidden_id']."' ");
                        ...
                        if(isset($_POST['btn_delete']))
                        {
                            if(isset($_POST['chk_delete']))
                            {
                                ...
                                {
                                    $delete_query = mysqli_query($con,"DELETE from tbl_applicants where id = '$value' ") or die('Error: ' . mysqli_error($con));
