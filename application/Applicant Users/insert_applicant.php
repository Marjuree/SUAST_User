...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $monthly_income = isset($_POST['monthly_income']) && is_numeric($_POST['monthly_income']) ? (int)$_POST['monthly_income'] : 0;
    ...
    applicant_id, lname, fname, mname, suffix, bdate, age, religion, nationality, civilstatus, ethnicity, contact,
    ...
    siblings, birth_order, monthly_income, indigenous, basic_sector, image_blob, document_blob, certificate_blob, tor_blob, card_blob, certificate_rating_blob, suast_form_blob, date_applied
        ...
        '$applicant_id', '$lname', '$fname', '$mname', '$suffix', '$bdate', '$age', '$religion', '$nationality', '$civilstatus', '$ethnicity',
        '$contact', '$purok', '$barangay', '$municipality', '$province', '$first_option', '$second_option', '$third_option', '$campus',
        '$gender', '$n_mother', '$n_father', '$c_mother', '$c_father', '$m_occupation', '$f_occupation',
