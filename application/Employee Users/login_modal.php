            ...
            <div class="modal-body">
                <form action="employee_login.php" method="POST" id="loginForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="loginPassword" name="employee_password"
                            required>
                    </div>
                    <button type="submit" class="btn btn-primary">Login</button>
                    <button type="button" class="btn btn-success" data-toggle="modal"
                        data-target="#regEmployee">Signup</button>
            ...
            <div class="modal-body">
                <form action="employee_registration.php" method="POST" id="registerForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="registerFirstName" name="employee_first_name"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="registerLastName" name="employee_last_name"
                            required>
                    </div>
                    <div class="form-group">
